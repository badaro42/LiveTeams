...
/**
 * Este m�todo � executado quando o utilizador carrega no mapa no formulario das equipas
...
function onMapClick(e) {
    ...
    var popupContent = "<p>Localiza��o atualizada com sucesso.<br />Nova localiza��o: [" +
