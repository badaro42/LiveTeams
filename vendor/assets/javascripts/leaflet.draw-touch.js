    ...
    L.drawVersion = "0.2.4-dev", L.drawLocal = {
        draw: {
            toolbar: {
                ...
                undo: {title: "Eliminar último ponto desenhado", text: "Eliminar último ponto"},
                buttons: {
            ...
            handlers: {
                ...
                marker: {tooltip: {start: "Clique no mapa para colocar o marcador."}},
                polygon: {
                    tooltip: {
                        start: "Clique para começar a desenhar a figura.",
                        cont: "Clique para continuar a desenhar a figura.",
                        end: "Clique no primeiro ponto para fechar a figura."
                    }
                },
                polyline: {
                    error: "<strong>Erro:</strong> as arestas das figuras não se podem cruzar!",
                    tooltip: {
                        start: "Clique para começar a desenhar a linha.",
                        cont: "Clique para continuar a desenhar a linha.",
                        end: "Clique no último ponto para concluir a linha."
                    }
                },
                rectangle: {tooltip: {start: "Clique e arraste para desenhar o rectângulo."}},
                simpleshape: {tooltip: {end: "Largue o rato para concluir o desenho."}}
            }
        },
        edit: {
            toolbar: {
                actions: {
                    save: {title: "Gravar alterações.", text: "Gravar"},
                    cancel: {title: "Cancelar edição, descartando as alterações.", text: "Cancelar"}
                },
                buttons: {
                    edit: "Editar camadas.",
                    editDisabled: "Não há camadas para editar.",
                    remove: "Elimine camadas.",
                    removeDisabled: "Não há camadas para eliminar."
                }
            },
            handlers: {
                edit: {
                    tooltip: {
                        text: "Arraste pontos ou marcadores para editas as entidades.",
                        subtext: "Clique cancelar para desfazer as altera��es."
                    }
                }, remove: {tooltip: {text: "Clique numa entidade para a remover."}}
            }
        }
        ...
        addHooks: function () {
            ...
            })), this._mouseMarker.on("mousedown", this._onMouseDown, this).addTo(this._map), this._map.on("mousemove", this._onMouseMove, this).on("mouseup", this._onMouseUp, this).on("zoomlevelschange", this._onZoomChange, this).on("click", this._onTouch, this))
        },
        removeHooks: function () {
            L.Draw.Feature.prototype.removeHooks.call(this), this._clearHideErrorTimeout(), this._cleanUpShape(), this._map.removeLayer(this._markerGroup), delete this._markerGroup, delete this._markers, this._map.removeLayer(this._poly), delete this._poly, this._mouseMarker.off("mousedown", this._onMouseDown, this).off("mouseup", this._onMouseUp, this), this._map.removeLayer(this._mouseMarker), delete this._mouseMarker, this._clearGuides(), this._map.off("mousemove", this._onMouseMove, this).off("mouseup", this._onMouseUp, this).off("zoomlevelschange", this._onZoomChange, this).off("click", this._onTouch, this)
        },
        ...
        _drawGuide: function (t, e) {
            var i, o, a, s = Math.floor(Math.sqrt(Math.pow(e.x - t.x, 2) + Math.pow(e.y - t.y, 2))), n = this.options.guidelineDistance, r = this.options.maxGuideLineLength, l = s > r ? s - r : n;
        ...
        options: {
            ...
            var t = this._poly;
            t instanceof L.Polygon || (t.options.editing.fill = !1), t.setStyle(t.options.editing), this._poly._map && (this._map = this._poly._map, this._markerGroup || this._initMarkers(), this._poly._map.addLayer(this._markerGroup))
        }, removeHooks: function () {
            var t = this._poly;
            ...
            var i, o, a, s = this._getMiddleLatLng(t, e), n = this._createMarker(s);
        ...
        initialize: function (t) {
            ...
            if (t.touches.length) {
                var i = this._map.mouseEventToContainerPoint(t.touches[0]), o = this._map.mouseEventToLayerPoint(t.touches[0]), a = this._map.layerPointToLatLng(o);
                this._map.fire(e, {
                    latlng: a,
                    layerPoint: o,
                    containerPoint: i,
        ...
        _initInteraction: function () {
            if (this.options.clickable) {
                var t = this._icon, e = ["dblclick", "mousedown", "mouseover", "mouseout", "contextmenu", "touchstart", "touchend", "touchmove", "touchcancel"];
        ...
        geodesicArea: function (t) {
            ...
            return e ? i = t >= 1e4 ? (1e-4 * t).toFixed(2) + " ha" : t.toFixed(2) + " m&sup2;" : (t /= .836127,
                i = t >= 3097600 ? (t / 3097600).toFixed(2) + " mi&sup2;" : t >= 4840 ? (t / 4840).toFixed(2) + " acres" : Math.ceil(t) + " yd&sup2;"), i
        ...
        intersects: function () {
            ...
            o = o || 0;
            for (var r = i; r > o; r--)if (a = n[r - 1], s = n[r], L.LineUtil.segmentsIntersect(t, e, a, s))return !0;
            return !1
        }
    }), L.Polygon.include({
        intersects: function () {
        ...
        includes: [L.Mixin.Events], initialize: function (t) {
            ...
            var e, i, o, a, s = this._actionsContainer, n = this.getActions(t), r = n.length;
        ...
        _enableLayerEdit: function (t) {
            ...
            this._backupLayer(i), this.options.selectedPathOptions && (e = L.Util.extend({}, this.options.selectedPathOptions), e.maintainColor && (e.color = i.options.color, e.fillColor = i.options.fillColor), i.options.original = L.extend({}, i.options), i.options.editing = e), this.isMarker ? (i.dragging.enable(), i.on("dragend", this._onMarkerDragEnd).on("touchmove", this._onTouchMove, this).on("touchend", this._onMarkerDragEnd, this)) : i.editing.enable()
        },
