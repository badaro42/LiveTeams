...
# "POLYGON(-9.157555103302002 38.66761893813652, -9.144165515899658 38.67324799343888, -9.128201007843018 38.65749892823337, -9.13764238357544 38.64811486000121, -9.145710468292236 38.6563594998049, -9.157555103302002 38.66761893813652)"

# TEAM_MEMBERS team_id:integer user_id:integer is_leader:boolean
puts 'Adding Geographic Entities'
GeoEntity.create(name: "Belo caminho por Portugal", user_id: 1,
...
GeoEntity.create(name: "Entrada para o Arsenal do Alfeite", user_id: 2,
                 latlon: "POINT(-9.154230505228043 38.658546181023475)",
                 description: "Tambem conhecida por Portao Verde") # Portão Verde

GeoEntity.create(name: "Base Naval de Lisboa - Arsenal do Alfeite", user_id: 3,
...
"POLYGON((-9.157555103302002 38.66761893813652, -9.144165515899658 38.67324799343888, " +
    "-9.128201007843018 38.65749892823337, -9.157555103302002 38.66761893813652))"