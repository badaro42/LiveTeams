...
regular_seeds = "SEEDS_NORMAIS"
usability_test_seeds = "SEEDS_TESTE_USABILIDADE"

# *****************************
# ALTERAR ESTE PARAMETRO!!!!!!!
# *****************************
seeds_to_use = usability_test_seeds

if seeds_to_use == usability_test_seeds
  puts "************************************"
  puts "************************************"
  puts "SEEDS PARA O ESTUDO DE USABILIDADE!!"
  puts "************************************"
  puts "************************************"

  # USER first_name:string last_name:string email:string password:string avatar:imagem
  puts '*USABILITY_TEST* Adding 11 Users'

  # id 1
  User.create(first_name: 'Administrador', last_name: 'Sistema', email: 'admin@mail.com', password: 'adminadmin',
  ...
  # id 2
  User.create(first_name: 'António', last_name: 'Estevex', email: 'antonio_esteves@mail.com', password: 'qweqweqwe',
              avatar: File.open(Rails.root + "app/assets/images/profile_pic_male_2.jpg"), password_confirmation: 'qweqweqwe',
              profile: Role::OPERACIONAL, phone_number: '212111112',
  ...
  # id 4
  User.create(first_name: 'Filipe', last_name: 'Pinto', email: 'filipe_pinto@mail.com', password: 'qweqweqwe',
  ...
  User.create(first_name: 'Rafael', last_name: 'Bizarra', email: 'rafael_bizarra@mail.com', password: 'qweqweqwe',
              ...
              profile: Role::GESTOR, phone_number: '212111116',
              latlon: 'POINT(-9.171277284622192 38.678508079563805)') # Cristo Rei
  # id 7
  User.create(first_name: 'João', last_name: 'Fonseca', email: 'joao_fonseca@mail.com', password: 'qweqweqwe',
  ...
  User.create(first_name: 'Antónia', last_name: 'Coelho', email: 'antonia_coelho@mail.com', password: 'qweqweqwe',
              ...
              profile: Role::BASICO, phone_number: '212111118',
  ...
  User.create(first_name: 'Rita', last_name: 'Nobre', email: 'rita_nobre@mail.com', password: 'qweqweqwe',
              ...
              profile: Role::OPERACIONAL, phone_number: '212111119',
  ...
  User.create(first_name: 'Ana', last_name: 'Henrique', email: 'ana_henrique@mail.com', password: 'qweqweqwe',
              ...
              profile: Role::BASICO, phone_number: '212111219',
              latlon: 'POINT(-8.903088569641113 38.49027879470561)') # Pen�nsula de Tr�ia
  # id 11
  User.create(first_name: 'Teste', last_name: 'Usabilidade', email: 'contadeteste@mail.com', password: 'contadeteste',
              avatar: File.open(Rails.root + "app/assets/images/teste.png"), password_confirmation: 'contadeteste',
              profile: Role::ADMINISTRADOR, phone_number: '212111120',
  ...
  puts '*USABILITY_TEST* Adding 7 Teams'
  Team.create(name: "Administradores")
  Team.create(name: "Sapadores Cacilhas")
  Team.create(name: "Proteção Civil Almada")
  Team.create(name: "PSP Seixal")
  Team.create(name: "Polícia Marítima Costa da Caparica")
  Team.create(name: "Escuteiros Corroios")
  Team.create(name: "Exército 14º Batalhão")


  # TEAM_MEMBER team_id:integer user_id:integer is_leader:boolean
  puts '*USABILITY_TEST* Associating users to teams'
  TeamMember.create(team_id: 1, user_id: 1)
  TeamMember.create(team_id: 1, user_id: 11)

  TeamMember.create(team_id: 2, user_id: 2)
  TeamMember.create(team_id: 2, user_id: 3)
  TeamMember.create(team_id: 2, user_id: 5)
  TeamMember.create(team_id: 2, user_id: 6)
  TeamMember.create(team_id: 2, user_id: 7)

  TeamMember.create(team_id: 3, user_id: 1)
  TeamMember.create(team_id: 3, user_id: 7)
  TeamMember.create(team_id: 3, user_id: 9)

  TeamMember.create(team_id: 4, user_id: 3)
  TeamMember.create(team_id: 4, user_id: 6)
  TeamMember.create(team_id: 4, user_id: 11)

  TeamMember.create(team_id: 5, user_id: 2)
  TeamMember.create(team_id: 5, user_id: 6)
  TeamMember.create(team_id: 5, user_id: 7)

  TeamMember.create(team_id: 6, user_id: 1)
  TeamMember.create(team_id: 6, user_id: 6)
  TeamMember.create(team_id: 6, user_id: 7)
  ...
  Team.update(2, created_by_user_id: 3, leader_id: 3, location_user_id: 2, latlon: User.find(2).latlon)
  Team.update(3, created_by_user_id: 1, leader_id: 1, location_user_id: 9, latlon: User.find(9).latlon)
  Team.update(4, created_by_user_id: 3, leader_id: 3, location_user_id: 3, latlon: User.find(3).latlon)
  Team.update(5, created_by_user_id: 6, leader_id: 6, location_user_id: 6, latlon: User.find(6).latlon)
  Team.update(6, created_by_user_id: 11, leader_id: 11, location_user_id: 7, latlon: User.find(7).latlon)
  Team.update(7, created_by_user_id: 3, leader_id: 3, location_user_id: 4, latlon: User.find(4).latlon)


  # CATEGORY name:string
  puts '*USABILITY_TEST* Adding categories'
  ...
  puts '*USABILITY_TEST* Adding Geographic Entities'
  ...
  GeoEntity.create(name: "Charneca da Caparica - Perigo", user_id: 5, entity_type: "marker", radius: 0,
                   latlon: "POINT(-9.203710556030273 38.63135453802258)",
                   description: "Árvore caída a obstruir a estrada", category_id: 2) # ID 5

  GeoEntity.create(name: "Vale Figueira - Perigo", user_id: 9, entity_type: "marker", radius: 0,
                   latlon: "POINT(-9.178390502929688 38.62733147755926)",
                   description: "Estrada inundada, sargeta entipuda", category_id: 2) # ID 6

  GeoEntity.create(name: "Informação à beira do Aterro Sanitário", user_id: 7, entity_type: "marker", radius: 0,
                   latlon: "POINT(-9.14637565612793 38.61861407216631)",
                   description: "Teste de cluster com o outro ao lado", category_id: 4) # ID 7

  GeoEntity.create(name: "Resolvido, para os lados do Talaminho", user_id: 2, entity_type: "marker", radius: 0,
  ...
  GeoEntity.create(name: "Posto de Controlo Móvel da Proteção Civil", user_id: 2, entity_type: "marker", radius: 0,
  ...
  GeoEntity.create(name: "Habitação 3: situação resolvida", user_id: 7, entity_type: "marker", radius: 0,
                   latlon: "POINT(-9.23750638961792 38.64318773210687)",
                   description: "O auxílo foi prestado. Cave inundada já está normalizada;",
                   category_id: 3) # ID 16

  GeoEntity.create(name: "Habitação 2: pede auxílio", user_id: 4, entity_type: "marker", radius: 0,
                   latlon: "POINT(-9.236712455749512 38.642332991765365)",
                   description: "Piso térreo alagado. Idosa acamada precisa de ambulância;",
                   category_id: 2) # ID 17

  GeoEntity.create(name: "Muro desabou", user_id: 5, entity_type: "marker", radius: 0,
  ...
  GeoEntity.create(name: "Restaurante 'Come Aqui: Bom e Barato': pede auxílio", user_id: 5, entity_type: "marker",
  ...
  GeoEntity.create(name: "Habitação 1: pede auxílio", user_id: 9, entity_type: "marker", radius: 0,
                   latlon: "POINT(-9.234459400177002 38.640246376935494)",
                   description: "Garagem/cave alagada",
                   category_id: 2) # ID 20

  GeoEntity.create(name: "Idoso diz que perdeu 50 euros", user_id: 11, entity_type: "circle", radius: 20,
  ...
  puts '*USABILITY_TEST* Associating geo-entities to teams'
  ...
  TeamGeoEntity.create(geo_entity_id: 5, team_id: 1)
  TeamGeoEntity.create(geo_entity_id: 5, team_id: 2)
  ...
  TeamGeoEntity.create(geo_entity_id: 13, team_id: 4)
  ...
  puts '*USABILITY_TEST* Adding Permissions'
  ...
  puts '*USABILITY_TEST* Adding Roles'
  ...
  puts '*USABILITY_TEST* Associating permissions to roles'
  ...
  puts '*USABILITY_TEST* Associating roles to users'
  UserRole.create(user_id: 1, role_id: 1, expiration_date: 10.years.since) # admin
  UserRole.create(user_id: 2, role_id: 3, expiration_date: 10.years.since) # operacional
  ...
  UserRole.create(user_id: 6, role_id: 2, expiration_date: 10.years.since) # gestor
  UserRole.create(user_id: 7, role_id: 3, expiration_date: 10.years.since) # operacional
  UserRole.create(user_id: 8, role_id: 4, expiration_date: 10.years.since) # basico
  ...
  puts "#############################"
  puts "#############################"
  puts "SEEDS PARA USAR NORMALMENTE!!"
  puts "#############################"
  puts "#############################"
